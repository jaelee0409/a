	...
	<body>
		...
		<!-- Contact -->
			<section id="contact" class="main style3 secondary">
				<div class="content container">
					<header>
						<h2>Say Hello.</h2>
						<p>Contact me through your email.</p>
					</header>
		...
		<!-- Footer -->
			<footer id="footer">
				...
				<!-- Icons -->
					<ul class="actions">
						<li><a href="https://www.facebook.com/JL0409" class="icon fa-facebook"><span class="label">Facebook</span></a></li>
						<li><a href="https://www.instagram.com/youjaelee" class="icon fa-instagram"><span class="label">Instagram</span></a></li>
						<li><a href="https://github.com/jaelee0409" class="icon fa-github"><span class="label">GitHub</span></a></li>
						<li><a href="https://www.linkedin.com/in/jae-lee-56a155128" class="icon fa-linkedin-square"><span class="label">LinkedIn</span></a></li>
					</ul>

				<!-- Menu -->
					<ul class="menu">
						<li>&copy; Jae Lee</li><li>Design: <a href="http://html5up.net">HTML5 UP</a></li>
					</ul>
